...
class AboutJobItem extends Component {
    ...
    if (responseJobData.ok === true) {
      ...
      const updatedJobDetailsData = [fetchedJobData.job_details].map(
        eachItem => ({
          ...
          employmentType: eachItem.employee_type,
          id: eachItem.id,
              ...
              <div className="location-package-container">
                <div className="location-job-type-container">
                  ...
                  <div className="employment-type-icon-employment-type-container">
                    <p className="job-type">{employeeType}</p>
                  </div>
                </div>
  ...
  renderJobFailureView = () => (
    <div className="jobs-details-failure-view">
      <img
  ...
  render() {
    return (
      <>
        <Header />
        <div className="jobs-details-view-container">
